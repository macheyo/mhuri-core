...
import zw.co.macheyo.mhuricore.service.account.AccountRepository;
...
public class DoubleEntryServiceImpl implements DoubleEntryService{
    ...
    @Override
    @Transactional
    public void addEntries(String accountToDebit, String accountToCredit, String reference, Double amount) {
